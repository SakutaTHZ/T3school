...
themeSwitch.addEventListener('change', function() {
    if (this.checked) {
        ...
        document.documentElement.style.setProperty('--whiteshadowcolor', 'rgba(0, 0, 0, 0.2)');
    } else {
        ...
        document.documentElement.style.setProperty('--whiteshadowcolor', 'rgba(255, 255, 255, 0.2)');
    }
});
